...
// Define redirectAllowlist here
export const redirectAllowlist: Set<string> = new Set([
...
export const isRedirectAllowed = (url: string): boolean => {
  return Array.from(redirectAllowlist).some((allowedUrl: string) => url.includes(allowedUrl));
};
